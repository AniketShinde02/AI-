        ...
        <nav className="flex-1 overflow-y-auto px-3 py-4 space-y-6">
          ...
          <div>
            ...
            <div className="mt-2 space-y-1">
              ...
              <a href="/api-docs" className="flex items-center gap-3 px-3 py-2 text-sm text-neutral-400 hover:bg-neutral-900 hover:text-white rounded-lg truncate transition-colors">
                <BookOpen size={16} className="shrink-0" /> Resources
              </a>
              <a href="/api-docs" className="flex items-center gap-3 px-3 py-2 text-sm text-nexus-cyan/80 hover:bg-neutral-900 hover:text-nexus-cyan rounded-lg truncate transition-colors">
                <FileText size={16} className="shrink-0" /> Developer Docs
              </a>
            </div>
          </div>
        </nav>
