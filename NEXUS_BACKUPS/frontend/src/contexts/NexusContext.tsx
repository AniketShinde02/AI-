...
interface NexusContextType {
  ...
  voiceState: "idle" | "listening" | "thinking" | "speaking" | "tool_running" | "interrupted";
  systemMetrics: any;
...
export function NexusProvider({ children }: { children: ReactNode }) {
  ...
  const [voiceState, setVoiceState] = useState<"idle" | "listening" | "thinking" | "speaking" | "tool_running" | "interrupted">("idle");
  ...
  const sendMessage = useCallback(async ({ content }: { content: string }): Promise<void> => {
    ...
    // Reset messages list if empty strings were left by streaming logic
