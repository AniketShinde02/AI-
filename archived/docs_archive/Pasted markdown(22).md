...
The following Draw.io XML flowchart represents the core Observe-Decide-Act-Verify loop integrated with dynamic rank themes and permission guardrails. This XML can be copied directly and loaded into Draw.io:
